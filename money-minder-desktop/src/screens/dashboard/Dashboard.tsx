      ...
      >
        <div className="p-6 max-w-7xl mx-auto space-y-6 bg-emerald-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Total Expenses Card */}
            <TileCard title="Total Expenses" amount={`${totalExpenses.toFixed(2)}`} />

            {/* Average Expense Card */}
            <TileCard title="Average Expense" amount={`${(totalExpenses / expenses.length).toFixed(2)}`} />

            {/* Add New Expense Card */}
            <Card className="border-emerald-200 bg-white shadow-sm hover:shadow-md transition-shadow">
              <CardHeader>
                <CardTitle className="text-emerald-700">Add Quick Expense</CardTitle>
              </CardHeader>
              ...
              <CardContent>
                <div className="space-y-4">
                  {topExpenses.map((expense) => (
                    <div
                      key={expense.id}
                      className="flex justify-between items-center p-3 bg-emerald-50 rounded hover:bg-emerald-100 transition-colors"
                    >
                      <div>
              ...
              <div className="space-y-2">
                {expenses
                  ...
                  .map((expense) => (
                    <div
                      key={expense.id}
                      className="flex justify-between items-center p-3 border-b border-emerald-100 hover:bg-emerald-50 transition-colors"
                    >
                      <div>
                        <p className="font-medium text-emerald-900">
                          {expense.description}
